...
namespace VolumetricCaustics
{
    ...
    public class CausticsInterpolation : MonoBehaviour
    {
        ...
        void UpdatePosition()
        {
            ...
            this.v0Normal = Vector3.Cross(this.v1 - this.v0, this.v2 - this.v0);
        ...
        private Matrix4x4 GetBeamSpaceTranform()
        {
            ...
            return Matrix4x4.LookAt(origin, origin + x, y);
        }
        ...
        Matrix4x4 LookAtLH(Vector3 eye, Vector3 at, Vector3 up)
        {
            ...
            ret.SetRow(0, new Vector4(xaxis.x, yaxis.x, zaxis.x, 0));
            ret.SetRow(1, new Vector4(xaxis.y, yaxis.y, zaxis.y, 0));
            ret.SetRow(2, new Vector4(xaxis.z, yaxis.z, zaxis.z, 0));
            ret.SetRow(3, new Vector4(-Vector3.Dot(xaxis, eye), -Vector3.Dot(yaxis, eye), -Vector3.Dot(zaxis, eye), 1));
